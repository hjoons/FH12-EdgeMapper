...
if __name__ == "__main__":
    ...
    parser.add_argument('--local', '-l', action='store_true', help="Set to train locally")

    args = parser.parse_args()
    if (args.local):
        train_with_local(args.data_path, args.checkpoint_path, lr=args.learning_rate, epochs=args.num_epochs, batch_size=args.batch)
    else:
        train(lr=args.learning_rate, epochs=args.num_epochs, batch_size=args.batch)
